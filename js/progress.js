...
function setup_bar()
{
	...
	document.write('<div id="nc" style="position: absolute;'
		+ 'top: ' + -60 + 'px'
		+ ';left: ' +0 + 'px'
		+ ';background:url(nc.jpg) #3B5998' //+ bar_background
	...
	document.write('<div id="empty_bar" style="position: absolute;'
		+ 'top: ' +0 + 'px'
		+ ';left: ' +0 + 'px'
		+ ';background-color: #3B5998' //+ bar_background
		+ ';width: 100%'
		+ ';height: 13px'
		+ ';font-family:"calibri"'
		+ ';">');
	...
	document.write('<div id="bar" style="position: absolute;'
		+ 'top: ' +0 + 'px'
		+ ';left: ' +0 + 'px'
		+ ';background-color: white' //+ bar_color
		+ ';width: ' + 0 + 'px'
		+ ';max-width: 100%' // Bug fix from Martijn189 on 4/13/10
		+ ';height: 13px'
		+ ';font-family:"calibri"'
		+ ';">');
	...
	document.write('</div>'); // close DIV for Wrapper
...
var bar_perc = Math.round(100 / image_count);
	...
	document.getElementById('bar').style.width = new_b_width + '%';
	//document.getElementById('nc').style.width = percent + '%';
	$('#nc').animate({'width': new_b_width + '%'}, 500);
	document.getElementById('nc').style.width = new_b_width + '%';
